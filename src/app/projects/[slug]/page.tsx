      ...
      <div className="flex flex-wrap items-center gap-3 mb-6">
        ...
        {frontmatter.liveUrl && (
          <Link
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center gap-2 bg-cyan-100 dark:bg-cyan-900/30 hover:bg-cyan-200 dark:hover:bg-cyan-800/50 text-cyan-800 dark:text-cyan-200 px-3 py-1 rounded-full text-sm transition"
          >
