...
export async function generateMetadata(props: {
  ...
  return {
    title: `Education | ${homeIntroConfig.name}`,
    description: "Explore my education and backend Java development training.",
...
export default async function WorkPage(props: {
  ...
  if (currentPage < 1 || (totalPages > 0 && currentPage > totalPages)) {
    return (
      <PageNotFound
        heading="Education page not found"
        description="The page you requested does not exist. Please return to the first education page."
        backHref="/work"
